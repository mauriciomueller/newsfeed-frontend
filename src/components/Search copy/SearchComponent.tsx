...
export const SearchComponent = () => {
    ...
    const { handleSearchOnFocus, handleSearchOnBlur } = useNavbarContext()
    ...
    return (
        <Form className="w-100 me-3 search" onSubmit={handleFilterSubmit}>
            <div className="container">
                ...
                <input type="text" className="form-control search-input" onFocus={handleSearchOnFocus} onBlur={handleSearchOnBlur} onChange={handleSearchInputChange} placeholder="Search..." aria-label="Search" />
            </div>
